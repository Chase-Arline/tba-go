...
type Match struct {
	Key, Comp_level          string
	Set_number, Match_number int
	Alliances                struct{ Red, Blue AllianceMatchData }
}

type AllianceMatchData struct {
	Score                                        int
	Team_keys, Surrogate_team_keys, Dq_team_keys []string
}
